...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-background via-background to-card flex items-center relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
              I'm a final year BCA student passionate about coding, tech, and problem-solving. I love building projects from scratch and exploring new technologies. My goal is to become a Software Engineer and contribute to open-source projects.
            </p>
            ...
            <div className="relative bg-card border border-border rounded-2xl p-8 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-background rounded-lg p-4 hover:bg-muted transition-colors group cursor-default">
                  ...
                  <p className="text-xs text-muted-foreground">MongoDB, MySQL</p>
                </div>
                <div className="bg-background rounded-lg p-4 hover:bg-muted transition-colors group cursor-default">
              ...
              <div className="pt-4 border-t border-border">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-xs font-semibold">React</span>
                  <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-xs font-semibold">Node.js</span>
                  <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-xs font-semibold">MongoDB</span>
                  <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-xs font-semibold">JavaScript</span>
                  <span className="px-3 py-1 bg-primary/20 text-primary rounded-full text-xs font-semibold">Tailwind</span>
                </div>
              </div>
            </div>
          </div>
